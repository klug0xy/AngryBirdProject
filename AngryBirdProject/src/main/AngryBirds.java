...
public class AngryBirds extends Panel implements Runnable, MouseListener, MouseMotionListener {
	double birdX, birdY, velocityX, velocityY; // informations relatives à
												// l'oiseau
	...
	boolean selecting; // vrai lorsque le joueur sélectionne l'angle et la
						// vitesse
	...
	public void paint(Graphics g2) {
		...
		if (selecting)
			g.drawLine((int) birdX, (int) birdY, mouseX, mouseY); // montre
																	// l'angle
																	// et la
																	// vitesse
